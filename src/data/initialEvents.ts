...
export const INITIAL_EVENTS: EventScenario[] = [
  {
    ...
    difficulty: 'Zor',
    description: 'Gece yarısı Yerebatan Sarnıcı\'nın suları yükselirken Medusa sütununun ardında eski bir tılsım parıldamaya başladı. Karan Göktürk ile birlikte gizemi çözün!',
    startingPrompt: '*Sarnıcın serin sularında yankılanan damla sesleri kesildi.* Karan dedektörünü doğrulttu: "Işıkları söndür... Medusa sütununun altındaki fısıltıyı duyuyor musun?"',
    agentName: 'Karan Göktürk',
  ...
  },
  {
    ...
    difficulty: 'Zor',
    description: 'Rams Park ve Kadıköy Şükrü Saracoğlu stadyumlarında meşaleler yakıldı! Aslan Burak ve Kanarya Efe ile derbinin taktiklerini belirleyip kupayı kaldırın.',
    startingPrompt: '*Stadyum hoparlörlerinden tezahüratlar yükseliyor.* Aslan Burak: "Kadıköy\'den geldiler ama Rams Park geçilmez!" Kanarya Efe: "Çubuklu ruhu her stadyumu fetheder!"',
  ...
  },
  {
    ...
    difficulty: 'Orta',
    description: 'Aylin Star Harbiye Açıkhava Tiyatrosu\'nda 20 bin kişilik dev hologram konserine çıkıyor! VIP kuliste stüdyo şovunu yönetin.',
  ...
  },
  {
    ...
    difficulty: 'Kolay',
    description: 'Bebek Koyu\'nda Iced Latte içerken TikTok ve X (Twitter) gündemine bomba gibi düşen caps olayını Selin Post ve Mert Trend ile gün yüzüne çıkarın!',
  ...
  },
  {
    ...
    agentName: 'Ayla Soylu (XASİL Mimar)',
